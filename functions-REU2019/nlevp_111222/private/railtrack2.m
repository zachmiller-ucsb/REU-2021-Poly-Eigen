function [coeffs,fun] = railtrack2(n,omega)
%RAILTRACK2   Palindromic QEP from model of rail tracks.
%  [COEFFS,FUN] = nlevp('railtrack2',N,OMEGA) returns matrices
...
%  References
%  E. King-wah Chu, T.-M. Hwang, W.-W. Lin and C.-T. Wu, Vibration of
%    fast trains, palindromic eigenvalue problems and
%    structure-preserving doubling algorithms, Journal of Computational
%    and Applied Mathematics, Vol. 219, 237-252, 2008.
%  T.-M. Huang, W.-W. Lin and J. Qian, Structure-preserving algorithms
%    for palindromic quadratic eigenvalue problems arising from
%    vibration on fast trains, SIAM J. Matrix Anal. Appl., Vol. 30, pp.
%    1566-1592, 2009.
