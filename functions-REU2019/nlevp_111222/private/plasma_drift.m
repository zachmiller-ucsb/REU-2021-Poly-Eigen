function [coeffs,fun] = plasma_drift(n)
%PLASMA_DRIFT Cubic PEP arising in Tokamak reactor design.
%  [COEFFS,FUN] = nlevp('plasma_drift',N) generates the coefficient matrices
...
%  FUN is a function handle to evaluate the monomials 1,lambda,..,lambda^3
