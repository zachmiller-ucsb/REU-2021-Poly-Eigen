function [coeffs,fun,sol] = fiber
%FIBER  NEP from fiber optic design.
%  [COEFFS,FUN,SOL] = nlevp('fiber') returns the 2400-by-2400 matrices
%  A, I and B in the nonlinear eigenvalue problem
...
%  This problem has the properties nep, sparse, solution.
