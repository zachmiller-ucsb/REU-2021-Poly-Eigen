function [coeffs,fun] = loaded_string(n,kappa,m)
%LOADED_STRING    REP from finite element model of a loaded vibrating string.
%   [COEFFS,FUN] = nlevp('loaded_string',N,KAPPA,m) generates an N-by-N
%   rational matrix function A - lambda*B + lambda/(lambda-sigma)*C
...
%   parameter_dependent, scalable, sparse.
