function [coeffs,fun] = planar_waveguide
%PLANAR_WAVEGUIDE   Quartic PEP from planar waveguide.
%  [COEFFS,FUN] = nlevp('planar_waveguide') returns the coefficients of
%  a 129-by-129 quartic matrix polynomial
...
%  This problem has the properties pep, real, symmetric.
