function [coeffs,fun,P] = metal_strip
%METAL_STRIP  QEP related to stability of electronic model of metal strip.
%  [COEFFS,FUN] = nlevp('metal_strip') generates the coefficient matrices
...
%  [COEFFS,FUN,P] = nlevp('metal_strip') also returns a symmetric
